...
disp('===================================================================')
disp(['EXCESS:' 9 'pC (95% C):= ' num2str(p_I_xcs(1),3) ' (' num2str(CI_xcs(1),3) ', ' num2str(CI_xcs(2),3) ')' 9 'Bias:= '  num2str(B_xcs,3)])
disp('-------------------------------------------------------------------')
disp(['MEANS:' 9 'pC (95% C):= ' num2str(p_I_mn(1),3) ' (' num2str(CI_mn(1),3) ', ' num2str(CI_mn(2),3) ')' 9 'Bias:= '  num2str(B_mn,3)])
disp('-------------------------------------------------------------------')
disp(['EMD:' 9 'pC (95% C):= ' num2str(p_I_emd(1),3) ' (' num2str(CI_emd(1),3) ', ' num2str(CI_emd(2),3) ')' 9 'Bias:= '  num2str(B_emd,3)])
disp('-------------------------------------------------------------------')
disp(['KDE:' 9 'pC (95% C):= ' num2str(p_I_kde(1),3) ' (' num2str(CI_kde(1),3) ', ' num2str(CI_kde(2),3) ')' 9 'Bias:= '  num2str(B_kde,3)])
